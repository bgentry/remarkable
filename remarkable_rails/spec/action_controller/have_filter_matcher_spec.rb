...
describe 'have_filter' do
  ...
  describe 'have_before_filter' do
    ...
    describe 'messages' do
      ...
      it 'should set only_matches? message' do
        ...
        matcher.failure_message.should == 'Expected controller to have before filter :require_user on action :new, got only on [:edit, :update]'
      end
    ...
    describe 'matchers' do
      it { should have_before_filter(:require_user) }
  ...
  describe 'have_after_filter' do
    ...
    describe 'matchers' do
      it { should have_after_filter(:require_user) }
    ...
    describe 'macros' do
      should_have_after_filter(:require_user)
