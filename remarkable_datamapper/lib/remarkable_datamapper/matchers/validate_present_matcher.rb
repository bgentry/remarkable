module Remarkable
  module DataMapper
    # Holds DataMapper matchers.
    #
    # == Validations matchers
    #
    # Remarkable supports all DataMapper validations, and the only options
    ...
    #
    module Matchers
      class ValidatePresentMatcher < Remarkable::DataMapper::Base #:nodoc:
      ...
      #
      def validate_present(*args, &block)
        ValidatePresentMatcher.new(*args, &block).spec(self)
      end
    end
  end
end
